...
export class NotificationService {
  ...
  sendLedgerChromeWarning() {
    this.sendWarning(
      ...
      `<a href="https://github.com/XIMEDIA/flairrvault/releases" target="_blank">FlairrVault Desktop</a>. ` +
      `&nbsp; <a href="https://github.com/XIMEDIA/flairrvault/issues/69" target="_blank">More Info</a>`,
